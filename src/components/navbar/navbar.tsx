        ...
        <div class="relative flex h-16 items-center justify-between">
          <div class="absolute inset-y-0 left-0 flex items-center xl:hidden">
            <button
              ...
              aria-expanded="false"
              onClick$={() =>
                (mobileMenuHiddenSignal.value = !mobileMenuHiddenSignal.value)
              }
            >
          ...
          <div class="flex flex-1 items-center justify-center xl:items-stretch xl:justify-start">
            <div class="flex flex-shrink-0 items-center">
              <Link href="/" class="text-sky-900 dark:text-sky-500">
                Curriculum
              </Link>
            </div>
            <div class="hidden xl:ml-6 xl:block">
              <div class="flex space-x-4">
                <div class="flex flex-row">
                  ...
                  <Navbutton
                    mobileMenuHiddenSignal={mobileMenuHiddenSignal}
                    pageName="Home"
                  />
                </div>
          ...
          <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <div class="relative ml-3 text-xs">
              <button
                onClick$={$(
                  () =>
                    (props.darkModeSignal.value = !props.darkModeSignal.value)
                )}
              >
